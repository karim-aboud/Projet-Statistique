...
**6 variables qualitatives** (Sex, ChestPainType, FastingBS, RestingECG, ExerciceAngina, ST_Slopem, HeartDisease) dont 1 variable cible (HeartDisease)
...
Calculons l'intervalle de confiance de la moyenne d'âge avec un niveau de confiance de **99%**.
...
On voit que lorsque la pente est ascendante, la médiane (et la moyenne) de la fréquence cardiaque maximale atteinte est supérieur (150) à lorsqu'elle est nulle (126). On remarque qu'il ya plus de variétés dans les modalités de **MaxHR** lorsque **ST_Slop** = ***Flat** (ça va de 60 jusqu'à presque 200).
...
Procédons maintenant à l'analyse Quanti x Quanti. Ici, on regarde la régression linéaire permettant (ou pas) d’expliquer la concentration en ozone par la température
